...
class Base:
    ...
    def create(cls, **dictionary):
        """Return an instance of the class instantiated from a dictionary of attributes.

        Args:
            **dictionary: Arbitrary keyword arguments containing the attributes as key-value pairs.
